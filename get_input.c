...
/**
 * get_input - This function read the line of input from user.
 *
 * Return: This function returns a pointer to a
 * buffer conatining the user's input.
*/
char *get_input(void)
{
	char *input = NULL;
...
/**
 * free_last_input - this function is used to frees
 * the most recent input entered by the user.
 *
 * This function frees the memory allocated for the
 * most recent input string
 * entered by the user.
